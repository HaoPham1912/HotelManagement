...
//
//import com.h2.hotelmangement.config.service.AccountDetailServiceImpl;
...
//            throws Exception {
//
//        auth.userDetailsService(accountDetailServiceImpl) // Cung cáp userservice cho spring security
...
////                .permitAll();
//        System.out.println(passwordEncoder().encode("duyle027"));
