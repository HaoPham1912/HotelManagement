...
// CONCATENATED MODULE: ./src/components/colorpicker/ColorPicker.vue?vue&type=template&id=c56c0eda&
    ...
    bindDocumentMouseMoveListener: function bindDocumentMouseMoveListener() {
      ...
      if (!this.documentMouseMoveListener) {
        this.documentMouseMoveListener = function (event) {
          if (_this4.colorDragging) {
            _this4.pickColor(event);
          }

          if (_this4.hueDragging) {
            _this4.pickHue(event);
          }
        };
    ...
    bindDocumentMouseUpListener: function bindDocumentMouseUpListener() {
      ...
      if (!this.documentMouseUpListener) {
        this.documentMouseUpListener = function () {
          _this5.colorDragging = false;
          _this5.hueDragging = false;
          DomHandler_DomHandler.removeClass(_this5.$el, 'p-colorpicker-dragging');

          _this5.unbindDocumentMouseMoveListener();

          _this5.unbindDocumentMouseUpListener();
        };
