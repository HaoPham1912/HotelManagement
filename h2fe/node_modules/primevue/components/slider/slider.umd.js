...
// CONCATENATED MODULE: ./src/components/slider/Slider.vue?vue&type=template&id=1f1b469a&
...
/* harmony default export */ var Slidervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    setValue: function setValue(event) {
      ...
      if (this.orientation === 'horizontal') handleValue = (pageX - this.initX) * 100 / this.barWidth;else handleValue = (this.initY + this.barHeight - event.pageY) * 100 / this.barHeight;
