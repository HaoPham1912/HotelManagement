...
// CONCATENATED MODULE: ./src/components/terminal/Terminal.vue?vue&type=template&id=cd49e75c&

// EXTERNAL MODULE: external {"commonjs":"vue","commonjs2":"vue","root":"Vue"}
var external_commonjs_vue_commonjs2_vue_root_Vue_ = __webpack_require__("8bbf");
var external_commonjs_vue_commonjs2_vue_root_Vue_default = /*#__PURE__*/__webpack_require__.n(external_commonjs_vue_commonjs2_vue_root_Vue_);

// CONCATENATED MODULE: ./src/components/terminal/TerminalService.js

var TerminalService = new external_commonjs_vue_commonjs2_vue_root_Vue_default.a();
/* harmony default export */ var terminal_TerminalService = (TerminalService);
...
/* harmony default export */ var Terminalvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    terminal_TerminalService.$on('response', this.responseListener);
  ...
  beforeDestroy: function beforeDestroy() {
    terminal_TerminalService.$off('response', this.responseListener);
  },
  methods: {
    ...
    onKeydown: function onKeydown(event) {
      if (event.keyCode === 13 && this.commandText) {
        ...
        terminal_TerminalService.$emit('command', this.commandText);
        this.commandText = '';
      }
    },
